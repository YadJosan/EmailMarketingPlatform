  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        setSuccess(response.data.message || 'Please check your email to verify your account.')
        // Don't clear email/password so user can see what they entered
      }
    } catch (err: any) {
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
        <div>
          <h2 className="text-center text-3xl font-bold text-gray-900">
            {showForgotPassword ? 'Reset your password' : isLogin ? 'Sign in to your account' : 'Create new account'}
          </h2>
        </div>
